<?php
class ModelReportAdvProfitModule extends Model {
	public function getProductCostPriceQuantity($start, $limit, &$count, $categoryfilter, $manufacturerfilter, $statusfilter, $roundingfilter, $sort) {
		global $keepsort;
		global $keepdir;
		$total = 0;
		$product_data = array();
		...
		if ($limit < 1) {
			...
			$sql = "SELECT p.product_id, p.quantity, pd.name, p.model, p.sku, p.price, p.subtract, p.cost, p.cost_amount, p.cost_percentage, p.cost_additional, p.costing_method FROM " . DB_PREFIX . "product p LEFT JOIN " . DB_PREFIX . "product_description pd ON (pd.product_id = p.product_id)";
	...
	public function createXLS($categoryfilter, $manufacturerfilter, $statusfilter, $roundingfilter) {
		// we use our own error handler
		global $config;
		global $log;
		$config = $this->config;
		...
		$textStockFormatYN->setColor('blue');	
		
		$workbook->setCustomColor(43, 255, 215, 215);
    	...
    	$results = $this->model_report_adv_profit_module->getProductCostPriceQuantity(1, 100000, $count, $categoryfilter, $manufacturerfilter, $statusfilter, $roundingfilter, '');
			...
			$excelRow = $i+1;			
				...
				$worksheet->writeFormula($i, $j++, '=SUM(H' . $excelRow . ':I' . $excelRow .')', $stockNewFormat);
				...
				$worksheet->writeFormula($i, $j++, '=IF(K' . $excelRow . '="AVCO",IF((H' . $excelRow . '*L' . $excelRow .'+I' . $excelRow .'*M' . $excelRow .') > 0,((H' . $excelRow . '*L' . $excelRow .'+I' . $excelRow .'*M' . $excelRow .')/SUM(H' . $excelRow . ':I' . $excelRow .')),M' . $excelRow . '),M' . $excelRow . ')', $costNewFormat);	
				...
				if ($roundingfilter == 'RD10DW') {
					$worksheet->writeFormula($i, $j++, '=IF(SUM(P' . $excelRow . ':R' . $excelRow . ') > 0,ROUNDDOWN((N' . $excelRow . '*P' . $excelRow . ')+(O' . $excelRow . '*Q' . $excelRow .')+(R' . $excelRow . '), 0)-0.10,0)', $priceNewFormat);					
				} elseif ($roundingfilter == 'RD5DW') {
					$worksheet->writeFormula($i, $j++, '=IF(SUM(P' . $excelRow . ':R' . $excelRow . ') > 0,ROUNDDOWN((N' . $excelRow . '*P' . $excelRow . ')+(O' . $excelRow . '*Q' . $excelRow .')+(R' . $excelRow . '), 0)-0.05,0)', $priceNewFormat);	
				} elseif ($roundingfilter == 'RD1DW') {
					$worksheet->writeFormula($i, $j++, '=IF(SUM(P' . $excelRow . ':R' . $excelRow . ') > 0,ROUNDDOWN((N' . $excelRow . '*P' . $excelRow . ')+(O' . $excelRow . '*Q' . $excelRow .')+(R' . $excelRow . '), 0)-0.01,0)', $priceNewFormat);	
				} elseif ($roundingfilter == 'RD00DW') {
					$worksheet->writeFormula($i, $j++, '=IF(SUM(P' . $excelRow . ':R' . $excelRow . ') > 0,ROUNDDOWN((N' . $excelRow . '*P' . $excelRow . ')+(O' . $excelRow . '*Q' . $excelRow .')+(R' . $excelRow . '), 0),0)', $priceNewFormat);					
				} elseif ($roundingfilter == 'RD0DW') {
					$worksheet->writeFormula($i, $j++, '=IF(SUM(P' . $excelRow . ':R' . $excelRow . ') > 0,ROUNDDOWN((N' . $excelRow . '*P' . $excelRow . ')+(O' . $excelRow . '*Q' . $excelRow .')+(R' . $excelRow . '), 1),0)', $priceNewFormat);				
				} elseif ($roundingfilter == 'RD') {
					$worksheet->writeFormula($i, $j++, '=IF(SUM(P' . $excelRow . ':R' . $excelRow . ') > 0,(N' . $excelRow . '*P' . $excelRow . ')+(O' . $excelRow . '*Q' . $excelRow .')+(R' . $excelRow . '),0)', $priceNewFormat);
				} elseif ($roundingfilter == 'RD0UP') {
					$worksheet->writeFormula($i, $j++, '=IF(SUM(P' . $excelRow . ':R' . $excelRow . ') > 0,ROUNDDOWN((N' . $excelRow . '*P' . $excelRow . ')+(O' . $excelRow . '*Q' . $excelRow .')+(R' . $excelRow . '), 1),0)', $priceNewFormat);
				} elseif ($roundingfilter == 'RD10UP') {
					$worksheet->writeFormula($i, $j++, '=IF(SUM(P' . $excelRow . ':R' . $excelRow . ') > 0,ROUNDDOWN((N' . $excelRow . '*P' . $excelRow . ')+(O' . $excelRow . '*Q' . $excelRow .')+(R' . $excelRow . ')+0.01, 0)-0.10,0)', $priceNewFormat);
				} elseif ($roundingfilter == 'RD5UP') {
					$worksheet->writeFormula($i, $j++, '=IF(SUM(P' . $excelRow . ':R' . $excelRow . ') > 0,ROUNDDOWN((N' . $excelRow . '*P' . $excelRow . ')+(O' . $excelRow . '*Q' . $excelRow .')+(R' . $excelRow . ')+0.01, 0)-0.05,0)', $priceNewFormat);
				} elseif ($roundingfilter == 'RD1UP') {
					$worksheet->writeFormula($i, $j++, '=IF(SUM(P' . $excelRow . ':R' . $excelRow . ') > 0,ROUNDDOWN((N' . $excelRow . '*P' . $excelRow . ')+(O' . $excelRow . '*Q' . $excelRow .')+(R' . $excelRow . ')+0.01, 0)-0.01,0)', $priceNewFormat);
				} elseif ($roundingfilter == 'RD00UP') {
					$worksheet->writeFormula($i, $j++, '=IF(SUM(P' . $excelRow . ':R' . $excelRow . ') > 0,ROUNDDOWN((N' . $excelRow . '*P' . $excelRow . ')+(O' . $excelRow . '*Q' . $excelRow .')+(R' . $excelRow . '), 0),0)', $priceNewFormat);
				} else {
					$worksheet->writeFormula($i, $j++, '=IF(SUM(P' . $excelRow . ':R' . $excelRow . ') > 0,(N' . $excelRow . '*P' . $excelRow . ')+(O' . $excelRow . '*Q' . $excelRow .')+(R' . $excelRow . '),0)', $priceNewFormat);
				}
				$worksheet->writeFormula($i, $j++, '=(S' . $excelRow . '-N' . $excelRow . ')', $profitNewFormat);
