...
class Modelblogsetup extends Model
{
	...
	public function createTables(){
        ...
        $this->db->query("INSERT INTO `" . DB_PREFIX . "blog_settings` (`settings_id`, `gallery_image_width`, `gallery_image_height`, `gallery_youtube_width`, `gallery_youtube_height`, `gallery_soundcloud_width`, `gallery_soundcloud_height`, `gallery_related_article_width`, `gallery_related_article_height`, `article_list_template`, `article_detail_template`, `article_related_template`, `article_page_limit`, `article_related_per_row`, `article_related_status`, `article_scroll_related`, `product_related_per_row`, `product_related_status`, `product_scroll_related`, `product_per_row`, `pagination_type`, `comments_engine`, `disqus_name`, `facebook_id`, `comments_approval`, `author_description`, `date_modified`)
                          VALUES (1, 1000, 400, 1000, 400, 1000, 140, 100, 100, 'default.tpl', 'default.tpl', 'default.tpl', 5, 3, 1, 0, 3, 1, 1, 3, 'AJAX', 'LOCAL', '', '', 1, 1, '0000-00-00 00:00:00');");
    ...
    function installSampleData()
    {
		...
		if( count($query->rows) > 0){
			...
			$queries[] = "
                    ...
                    (27, 7, 'CLASSIC', 2, 'catalog/blog/Ubuntu_12.04-150x150.png', 1, 1, '2015-09-16 00:10:18', '2015-09-16 00:09:56', '2015-09-16 00:09:56'),
                    (18, 9, 'SLIDER', 2, 'catalog/blog/laptopmockup_sliderdy-150x150.jpg', 1, 1, '2015-09-16 00:10:24', '2015-09-16 00:00:02', '2015-09-16 00:00:02'),
                    (65, 8, 'CLASSIC', 0, 'catalog/blog/4.jpg', 1, 1, '2015-09-12 16:49:41', '2015-09-12 16:49:41', '2015-09-12 16:49:41'),
                    (64, 8, 'SLIDER', 0, 'catalog/blog/3.jpg', 1, 1, '2015-09-06 18:50:44', '2015-09-06 18:50:44', '2015-09-06 18:50:44'),
                    (25, 8, 'CLASSIC', 3, 'catalog/blog/5.jpg', 1, 1, '2015-09-03 01:09:25', '2015-09-03 01:09:25', '2015-09-03 01:09:25'),
                    (20, 8, 'SLIDER', 1, 'catalog/blog/Ubuntu_12.04-150x150.png', 1, 1, '2015-09-01 21:09:43', '2015-09-01 21:09:43', '2015-09-01 21:09:43'),
                    (63, 8, 'CLASSIC', 0, 'catalog/blog/3.jpg', 1, 1, '2015-08-27 00:08:35', '2015-08-26 22:16:12', '2015-08-26 22:16:12'),
                    (34, 7, 'CLASSIC', 7, 'catalog/blog/2-150x150.jpg', 1, 0, '2015-09-16 22:27:46', '2015-08-11 12:22:11', '2015-08-11 12:22:11');
                ";
			$queries[] = "
			...
			$queries[] = "
                    ...
                    (2689, 27, 'catalog/blog/blog-post-image.jpg', 1100, 602, 'IMG', '', 1),
                    (2684, 25, 'catalog/blog/blog-post-image.jpg', 1100, 602, 'IMG', '', 1),
                    (2680, 18, 'catalog/blog/slider-2.jpg', 889, 450, 'IMG', '', 1),
                    (2681, 18, 'catalog/blog/slider-1.jpg', 889, 450, 'IMG', '', 2),
                    (2686, 20, 'catalog/blog/slider-2.jpg', 889, 450, 'IMG', '', 1),
                    (2687, 20, 'catalog/blog/slider-1.jpg', 889, 450, 'IMG', '', 2),
                    (2685, 65, 'catalog/blog/slider-2.jpg', 889, 450, 'IMG', '', 1),
                    (2690, 64, 'catalog/blog/slider-1.jpg', 889, 450, 'IMG', '', 1);
            ";
			...
			$queries[] = "
                ...
                ";
			$queries[] = "
                    INSERT INTO `" . DB_PREFIX . "blog_author` (`author_id`, `name`, `image`, `sort_order`) VALUES 
                    (7, 'Mathew Roy', 'catalog/blog/2-150x150.jpg', 3),
                    (8, 'Anna Donson', 'catalog/blog/blog-author.jpg', 1),
                    (9, 'Michael Lindey', 'catalog/blog/1-150x150.jpg', 2);
                ";
			$queries[] = "
                    INSERT INTO `" . DB_PREFIX . "blog_author_description` (`author_id`, `language_id`, `description`) VALUES 
                    (8, 1, '&lt;p&gt;&lt;span style=&quot;text-align: justify;&quot;&gt;Suspendisse potenti. Suspendisse vel feugiat ipsum. Phasellus aliquam velit id euismod euismod. Duis pharetra urna id nulla scelerisque dapibus. Integer nec tempor lacus. Aliquam porttitor nisi nec gravida maximus. Morbi molestie dignissim magna a volutpat.&lt;/span&gt;&lt;br&gt;&lt;/p&gt;'),
                    (9, 1, '&lt;p&gt;&lt;span style=&quot;text-align: justify;&quot;&gt;Suspendisse potenti. Suspendisse vel feugiat ipsum. Phasellus aliquam velit id euismod euismod. Duis pharetra urna id nulla scelerisque dapibus. Integer nec tempor lacus. Aliquam porttitor nisi nec gravida maximus. Morbi molestie dignissim magna a volutpat.&lt;/span&gt;&lt;br&gt;&lt;/p&gt;'),
                    (7, 1, '&lt;p&gt;&lt;span style=&quot;text-align: justify;&quot;&gt;Suspendisse potenti. Suspendisse vel feugiat ipsum. Phasellus aliquam velit id euismod euismod. Duis pharetra urna id nulla scelerisque dapibus. Integer nec tempor lacus. Aliquam porttitor nisi nec gravida maximus. Morbi molestie dignissim magna a volutpat.&lt;/span&gt;&lt;br&gt;&lt;/p&gt;');
                ";
            ...
            foreach($data['languages'] as $language) {
                if($language['language_id'] != 1) {
                    ...
                    $queries[] = "
                            INSERT INTO `" . DB_PREFIX . "blog_author_description` (`author_id`, `language_id`, `description`) VALUES 
                            (8, $language_id, '&lt;p&gt;&lt;span style=&quot;text-align: justify;&quot;&gt;Suspendisse potenti. Suspendisse vel feugiat ipsum. Phasellus aliquam velit id euismod euismod. Duis pharetra urna id nulla scelerisque dapibus. Integer nec tempor lacus. Aliquam porttitor nisi nec gravida maximus. Morbi molestie dignissim magna a volutpat.&lt;/span&gt;&lt;br&gt;&lt;/p&gt;'),
                            (9, $language_id, '&lt;p&gt;&lt;span style=&quot;text-align: justify;&quot;&gt;Suspendisse potenti. Suspendisse vel feugiat ipsum. Phasellus aliquam velit id euismod euismod. Duis pharetra urna id nulla scelerisque dapibus. Integer nec tempor lacus. Aliquam porttitor nisi nec gravida maximus. Morbi molestie dignissim magna a volutpat.&lt;/span&gt;&lt;br&gt;&lt;/p&gt;'),
                            (7, $language_id, '&lt;p&gt;&lt;span style=&quot;text-align: justify;&quot;&gt;Suspendisse potenti. Suspendisse vel feugiat ipsum. Phasellus aliquam velit id euismod euismod. Duis pharetra urna id nulla scelerisque dapibus. Integer nec tempor lacus. Aliquam porttitor nisi nec gravida maximus. Morbi molestie dignissim magna a volutpat.&lt;/span&gt;&lt;br&gt;&lt;/p&gt;');
                        ";
                }
            }
            ...
            foreach($data['languages'] as $language) {
                if($language['language_id'] != 1) {
                    ...
                    $queries[] = "
                            INSERT INTO `" . DB_PREFIX . "blog_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES 
                            (46, $language_id, 'Quotes', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Quotes', '', ''),
                            (18, $language_id, 'Links &amp; Quotes', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;\r\n', 'Links &amp; Quotes', '', ''),
                            (25, $language_id, 'Entertaiment', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Entertaiment', '', ''),
                            (34, $language_id, 'Events', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;\r\n', 'Events', '', ''),
                            (45, $language_id, 'Links', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Links', '', ''),
                            (24, $language_id, 'Company', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Company', '', ''),
                            (26, $language_id, 'Logistic', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Logistic', '', ''),
                            (31, $language_id, 'Theater', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Theater', '', ''),
                            (27, $language_id, 'Car', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Car', '', ''),
                            (20, $language_id, 'Enterprise', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;\r\n', 'Enterprise', '', ''),
                            (33, $language_id, 'Sports', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Sports', '', ''),
                            (57, $language_id, 'Stories', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Stories', '', ''),
                            (28, $language_id, 'Gaming', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Gaming', '', ''),
                            (30, $language_id, 'Film', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Film', '', ''),
                            (17, $language_id, 'Business', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Business', '', '');
                        ";
                }
            }
            ...
            if($query->row){
                ...
                $output["blog_search_module"] = array (
                  1 => 
                  array (
                    'heading_title' => array(
                        1 => 'Search'
                ...
                $this->model_setting_setting->editSetting( "blog_search", $output );
                $output = array();
                ...
                // PRODUCT
                $query = $this->db->query("SELECT layout_id FROM " . DB_PREFIX . "layout WHERE name = 'Product'");

                if($query->row){
                    $layout_id = $query->row['layout_id'];
            
                
                    $output["blog_related_post_module"] = array (
                      1 => 
                      array (
                        'heading_title' => array(
                            1 => 'Related Posts'
                    ...
                    $this->model_setting_setting->editSetting( "blog_related_post", $output );
                }
