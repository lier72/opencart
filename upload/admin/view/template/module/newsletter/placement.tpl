						...
						<div class="tab-content2">
							...
							<div id="newsletter_module_<?php echo $i; ?>" style="padding-top:20px">
								<div id="language_<?php echo $i; ?>" class="htabs">
									...
									<a href="#tab_language_<?php echo $i; ?>_<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
									<?php } ?>
								</div>
							...
							<script type="text/javascript">
								...
								function addModule() {
									...
									<?php foreach ($languages as $language) { ?>
									html += '    <a href="#tab_language_'+ module + '_<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>';
									<?php } ?>
									html += '  </div>';
