  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <?php if ($laccess) { ?><button type="submit" form="form-adv" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button><?php } ?> 
		...
		<table width="100%" class="table table-bordered">
			<tr>
            	<td width="30%" class="text-left"><?php echo $text_sold_order_status; ?></td>
              	<td width="70%" class="text-left"><select name="adv_sold_order_status" class="form-control">
