...
$_['entry_default_data']				= '<span data-toggle="tooltip" title="Если включено, то можно задать размеры и вес в отгрузке по умочанию.">Параметры для отгрузки по умолчанию</span>';
$_['entry_weight_default']				= '<span data-toggle="tooltip" title="Необходимо задать вес по умолчанию в килограммах">Вес по умолчанию</span>';
$_['entry_data_work_mode_default']		= '<span data-toggle="tooltip" title="Необходимо выбрать режим работы подстановки параметров для отгрузки">Использование данных</span>';
...
$_['entry_shipment_point_default']      = 'Пункт отгрузки заказов по умолчанию';
$_['entry_status']						= 'Статус:';
$_['entry_sort_order']					= 'Порядок сортировки:';
$_['entry_size']						= 'Размеры отправления';
$_['entry_size_help']					= 'Указывается в сантиметрах';
$_['entry_tariff']						= 'Тариф';
$_['entry_seller_telephone']			= 'Телефон отправителя';
$_['entry_seller_inn']					= '<span data-toggle="tooltip" title="Обязательно если заказ - международный">ИНН отправителя</span>';
$_['entry_seller_address']				= '<span data-toggle="tooltip" title="Обязательно если если заполнен ИНН">Адресс отправителя</span>';
$_['entry_sell_address']				= 'Адресс забора груза';
$_['entry_pvz_sell']			    	= 'Пункт отправки груза';
$_['entry_seller_ownership']			= '<span data-toggle="tooltip" title="Обязательно если если заполнен ИНН">Формы собственности отправителя</span>';
$_['entry_package_default']             = 'Вид упаковки товаров';
