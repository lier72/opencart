<?php
$_['heading_title']      = 'Yandexmoney - Visa, Mastercard, Maestro ++';
$_['entry_login']        = 'Wallet number';
$_['entry_password']     = 'Secret word';
$_['entry_komis'] 		 = 'Commission from the buyer';
...
$_['entry_yandexplusplus_card_instruction'] = 'Instructions when ordering:<br/><small>Supports variables:<br/>$href$ - reference to the payment<br/>$orderid$ - order number<br/>$itogo$ - order amount<br/>$komis$ - comission Percentage<br/>$total-komis$ - calculate the commission of the amount<br/>$plus-komis$ - programming with the Commission<br/>as well as html tags.</small>';
$_['entry_yandexplusplus_card_instruction_tab']      = 'Use the instructions when ordering?';
$_['entry_yandexplusplus_card_mail_instruction_tab']      = 'Use the instructions in the letter with the order?';
$_['entry_yandexplusplus_card_mail_instruction']      = 'Instruction in a letter to the order:<br/><small>Supports variables:<br/>$href$ - reference to the payment<br/>$orderid$ - order number<br/>$itogo$ - order amount<br/>$komis$ - comission Percentage<br/>$total-komis$ - calculate the commission of the amount<br/>$plus-komis$ - programming with the Commission<br/>as well as html tags.</small>';
$_['entry_yandexplusplus_card_success_comment_tab']      = 'Used successfully in a letter to the buyer of your successful payment?';
$_['entry_yandexplusplus_card_success_comment']      = 'Successfully the buyer in writing of successful payment:<br/><small>Supports variables:<br/>$orderid$ - order number<br/>$itogo$ - order amount</small>';
$_['entry_yandexplusplus_card_name_tab']      = 'The text in the name of the method of payment?';
$_['entry_yandexplusplus_card_name']      = 'Name of the method of payment';
$_['entry_yandexplusplus_card_success_alert_admin_tab']      = 'Mail to the administrator upon successful payment';
$_['entry_yandexplusplus_card_success_alert_customer_tab']      = 'Letter to the buyer upon successful payment';
$_['entry_yandexplusplus_card_success_page_tab']      = 'Your text on the page successful payment?';
...
$_['error_login']      = 'Enter the number of the wallet';
