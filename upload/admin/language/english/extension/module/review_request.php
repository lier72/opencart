...
$_['text_review_follow_up']           = 'Review Follow-Up';
$_['text_no_review_replies']          = 'No tracked review clicks yet.';
$_['text_sent_label']                 = 'Sent';
$_['text_period']                     = 'Period';
$_['text_product_only']               = 'Send Product Reviews Only';
$_['text_skip_email']                 = 'Skip Email';
$_['text_bonus_awarded']              = 'Awarded: %s points on %s';
$_['text_bonus_disabled']             = 'Review bonus is disabled.';
$_['text_bonus_guest']                = 'Guest order: only registered customers can receive bonus points.';
$_['text_review_bonus_success']       = 'Review bonus awarded: %s points added to the customer account.';
...
$_['entry_review_bonus_points']       = 'Review Bonus Points';
...
$_['help_review_bonus_points']        = 'Set how many loyalty points to award after you verify a published store review. Use 0 to disable. Only registered customers can receive these points.';
...
$_['help_review_follow_up']           = 'Use this list to verify published reviews and award the configured review bonus directly from this module.';

$_['button_order']                    = 'Order';
$_['button_customer']                 = 'Customer';
$_['button_award_bonus']              = 'Award Bonus';
$_['button_reward_points']            = 'Reward Points';
...
$_['error_review_bonus_points']       = 'Review bonus points must be zero or a positive integer.';
$_['error_review_bonus_not_found']    = 'Review request record was not found.';
$_['error_review_bonus_not_replied']  = 'This request has no tracked review click yet.';
$_['error_review_bonus_already_awarded'] = 'Bonus points have already been awarded for this review request.';
$_['error_review_bonus_guest']        = 'Guest orders cannot receive automatic review bonus points.';
$_['error_review_bonus_disabled']     = 'Review bonus awarding is disabled in the module settings.';
$_['error_review_bonus_failed']       = 'Unable to award review bonus points.';
