...
class ControllerPaymentRbs extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['rbs_order_status_id'])) {
            $data['rbs_order_status_id'] = $this->request->post['rbs_order_status_id'];
        } else {
            $data['rbs_order_status_id'] = $this->config->get('rbs_order_status_id');
        }
        ...
        // Текст инструкции в Detail of payment
        
        $data['entry_rbs_info_text'] = $this->language->get('entry_rbs_info_text');
        
		$this->load->model('localisation/language');
		$languages = $this->model_localisation_language->getLanguages();
		foreach ($languages as $language) {
			if (isset($this->request->post['rbs_info_text' . $language['language_id']])) {
				$data['rbs_info_text' . $language['language_id']] = $this->request->post['rbs_info_text' . $language['language_id']];
			} else {
				$data['rbs_info_text' . $language['language_id']] = $this->config->get('rbs_info_text' . $language['language_id']);
			}
		}
        ...
        $data['rbs_ofd_status'] = $this->config->get('rbs_ofd_status');
