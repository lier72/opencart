...
class ControllerExtensionShippingFree extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['shipping_free_customer_group_id'])) {
			$data['shipping_free_customer_group_id'] = $this->request->post['shipping_free_customer_group_id'];
		} else {
			$data['shipping_free_customer_group_id'] = $this->config->get('shipping_free_customer_group_id');
		}
