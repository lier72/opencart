-- ============================================================================
-- BONUS LOYALTY LEVELS - DATABASE INSTALLATION (UTF-8 Fixed)
-- ============================================================================
-- This script creates the loyalty program information page and sets default
-- loyalty level thresholds in the settings table
--
-- USAGE:
-- mysql -u root --default-character-set=utf8 a1627-unqs-oc3 < admin/bonus_loyalty_levels_install_fixed.sql
-- ============================================================================
