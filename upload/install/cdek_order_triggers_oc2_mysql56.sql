-- ============================================
-- CDEK Order Triggers for OC2 - MySQL 5.6 Compatible
-- Syncs cdek_order data from OC2 to OC3
...
SELECT 'CDEK order triggers (INSERT, UPDATE) installed successfully for OC2 (MySQL 5.6)' AS status;
