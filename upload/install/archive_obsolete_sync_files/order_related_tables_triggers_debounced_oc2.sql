-- ============================================
-- Order Related Tables Sync Triggers WITH DEBOUNCING (OC2)
...
CREATE TRIGGER `ocus_order_product_after_insert_sync_oc2`
...
CREATE TRIGGER `ocus_order_product_after_delete_sync_oc2`
...
CREATE TRIGGER `ocus_order_total_after_insert_sync_oc2`
...
CREATE TRIGGER `ocus_order_total_after_delete_sync_oc2`
...
CREATE TRIGGER `ocus_order_option_after_insert_sync_oc2`
...
CREATE TRIGGER `ocus_order_option_after_delete_sync_oc2`
...
SELECT 'Debounced triggers created for OC2 (order_product, order_total, order_option)' AS status;
