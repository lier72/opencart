-- ============================================
-- Order History Triggers for OC3 - MySQL 5.6 Compatible
...
SELECT 'Order history triggers (INSERT, UPDATE, DELETE) installed successfully for OC3 (MySQL 5.6)' AS status;
