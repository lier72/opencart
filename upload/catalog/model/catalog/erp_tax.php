...
class ModelCatalogErpTax extends Model {
    ...
    public function addto_tax_merge($erp_tax_id, $tax_id, $op_user = 'Front End'){
        ...
        $tax_id = $this->db->query("INSERT INTO `".DB_PREFIX. "erp_tax_merge` SET erp_tax_id = '$erp_tax_id' ,opencart_tax_id = '$tax_id', rate = '$rate' , created_by = '$op_user', created_on = NOW() ");
    }
}
?>
