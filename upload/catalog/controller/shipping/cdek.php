...
// Maxim Surdu makes variable trace - writes to /var/log/apache/error_log - Will use it later for debugging
//		$this->log->write("Sdek PVZ: ". $this->session->data['sdek']['pvz'] . ", " . $this->session->data['sdek']['pvzinfo']);
	}
