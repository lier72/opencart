...
class ControllerProductSpecial extends Controller {
	public function index() {
		...
		// Get special products (always use the standard method which Journal3 may intercept)
		...
		if ($is_enabled) {
			...
			$data['sorts'][] = array(
				...
				'href'  => $this->url->link('product/special', 'sort=personalized&order=DESC' . $url)
			);
		} else {
			...
			$data['sorts'][] = array(
				...
				'href'  => $this->url->link('product/special', 'sort=enable-personalized&order=DESC' . $url)
			);
		}
		}
