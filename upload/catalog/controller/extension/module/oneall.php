...
class ControllerExtensionModuleOneall extends Controller
{
    ...
    // route=extension/module/oneall/register
    public function register()
    {
        ...
        $data['breadcrumbs'] = array(
            ...
            array(
                ...
                'href' => $this->url->link('extension/module/oneall/register', '', true)
            )
        );
        ...
        // Form Action
        $data['action'] = $this->url->link('extension/module/oneall/register', '', true);
        ...
        // Display Template
        $this->response->setOutput($this->load->view('extension/module/oneall_register', $data));
    }
