	               ...
	               if($module['type'] == 'newsletter') {
	                    ...
	                    if(isset($module['newsletter']['title'][$this->config->get('config_language_id')])) {
	                         $content = array(
	                              ...
	                              'subscribe_url' => $this->url->link('module/newsletter/subscribe', '', 'SSL'),
	                              'unsubscribe_url' => $this->url->link('module/newsletter/unsubscribe', '', 'SSL')
	                         );
	                    } else {
	                         $content = array(
	                              'title' => 'Set name!',
          	     		...
          	     		if($module['products']['get_products_from'] == 'latest') {
          	          	...
          	          	foreach ($results as $result) {
                                ...
                                $products[] = array(
                                    ...
                                    'img_width' => $module['products']['width'],
                                    'img_height' => $module['products']['height'],
