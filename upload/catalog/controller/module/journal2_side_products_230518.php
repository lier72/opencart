...
// Modificattions made by Max Surdu to show correct retail_price 
                if ($this->customer->isLogged()) {
                    if (version_compare(VERSION, '2.2', '>=')) {
                        ...
                        $retail_price = $this->currency->format($this->tax->calculate($product['retail_price'], $product['tax_class_id'], $this->config->get('config_tax')));
                    }
                } else {
                    $retail_price = false;
                }
// End of modifications
                ...
                $products_data[] = array(
                    ...
                    'name'          => $product['name'],
                    'price'         => $price,
// Modifications to show retail_price when user is loggedIn
