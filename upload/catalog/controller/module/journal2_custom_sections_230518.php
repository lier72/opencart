...
// Modifications made to show retail_price when user is logged only
                if ($this->customer->isLogged()) {
                    $retail_price = Journal2Utils::currencyFormat($this->tax->calculate($product['retail_price'], $product['tax_class_id'], $this->config->get('config_tax')));
                } else {
                    $retail_price = false;
                }
// end of modifications
                ...
                $product_data = array(
                    ...
                    'name'          => $product['name'],
                    'price'         => $price,
// Modification to show retail_price
