...
<div class="post">
    <div class="post-entry">
        ...
        <?php if($settings['comments_engine'] == 'LOCAL'):?>
            <div class="comments">
                <h3><?php echo $text_comments ?>: <?php echo $article['comments_count']; ?></h3>
            ...
            <div id="reply-block" class="leave-reply">
                <h3><?php echo $text_leave_reply ?></h3>
                <p><?php echo $text_required_info ?><abbr class="required">*</abbr> </p>
...
<?php if(!empty($products) && $settings['product_related_status'] == 1) : ?>
  ...
  if($settings['product_related_per_row'] == 4) { $class = 3; }
