			    ...
			    <div class="col-sm-<?php echo $image_grid; ?> popup-gallery">
			      <div class="row">
						...
						<div class="thumbnails thumbnails-left clearfix">
							<ul>
							  <?php if($thumb) { ?>
						      <li><p><a href="<?php echo $popup; ?>" class="popup-image" data-image="<?php echo $popup; ?>" data-zoom-image="<?php echo $popup; ?>"><img src="<?php echo $theme_options->productImageThumb($product_id, $config->get('config_image_additional_width'), $config->get('config_image_additional_height')); ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></p></li>
							  <?php } ?>
				      ...
				      <div class="col-sm-<?php if($theme_options->get( 'position_image_additional' ) == 2) { echo 10; } else { echo 12; } ?>">
					      ...
					      <div class="product-image inner-cloud-zoom">
                            ...
                            <?php endif; ?>
					     	 ...
					     	 <a href="#" title="<?php echo $heading_title; ?>" id="ex1"><img src="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" itemprop="image" data-zoom-image="<?php echo $popup; ?>" /></a>
					      </div>
					  	 <?php } else { ?>
			    ...
			    <div class="col-sm-<?php echo $product_center_grid; ?> product-center clearfix">
			     <div itemprop="offerDetails" itemscope itemtype="http://data-vocabulary.org/Offer">
			      ...
			      <h2 class="product-name">
                        <a href="#" class="review-link"><?php echo $heading_title; ?></a>
                        <div class="product-brand">
                            <?php if ($manufacturer) { ?>
                            <a href="<?php echo $manufacturers; ?>" itemprop="brand"><?php echo $manufacturer; ?></a>
                            <?php } ?>
                        </div>
                  </h2>
			        <div class="links">
