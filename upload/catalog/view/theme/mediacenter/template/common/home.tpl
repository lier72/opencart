...
<div class="main-content <?php if($theme_options->get( 'content_layout' ) == 2) { echo 'fixed'; } else { echo 'full-width'; } ?> home">
					...
					<div class="col-sm-12 col-md-3">
						...
						if( count($preface_left) ) {
							foreach ($preface_left as $module) {
                                echo $theme_options->get( 'effect_type' ) != '' && strpos($module,'megamenu') === false  && strpos($module,'rev_slider_wrapper') === false ? '<div class="wow '.$theme_options->get( 'effect_type' ).'">' : '';
								echo $module;
                                echo $theme_options->get( 'effect_type' ) != '' && strpos($module,'megamenu') === false  && strpos($module,'rev_slider_wrapper') === false ? '</div>' : '';
							}
						} ?>
					</div>
					...
					<div class="col-sm-12">
						<?php
							foreach ($preface_fullwidth as $module) {
                                echo $theme_options->get( 'effect_type' ) != '' ? '<div class="wow '.$theme_options->get( 'effect_type' ).'">' : '';
								echo $module;
                                echo $theme_options->get( 'effect_type' ) != '' ? '</div>' : '';
							}
						?>
					</div>
				</div>
    ...
    <?php if($theme_options->get( 'scroll_effect' ) == 1): ?>
<script>
    $(function(){
        // WOW 
       wow = new WOW(
