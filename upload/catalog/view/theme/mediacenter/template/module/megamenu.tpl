														...
														if($submenu['content_type'] == '0') {
															...
															if(is_array($submenu['product'])) {
																echo '<div class="product">';
                                                                    ...
                                                                    $product_detail = $theme_options->getDataProduct( $submenu['product']['id'] );
                                                                    $text_sale = 'Sale';
                                                                    ...
                                                                    if($theme_options->get( 'display_text_sale' ) != '0') {
                                                                        if($theme_options->get( 'type_sale' ) == '0') {
                                                                            echo '<div class="ribbon red sale"><span>' . $text_sale . '</span></div>';
                                                                        }
                                                                    }


                                                                    if($product_detail['is_bestseller'] && $theme_options->get( 'display_text_bestseller' ) != '0'){
                                                                        echo '<div class="ribbon green bestseller"><span>'. $text_bestseller .'</span></div>';
                                                                    }
                                                                    if($product_detail['is_latest'] && $theme_options->get( 'display_text_latest' ) != '0'){
                                                                        echo '<div class="ribbon blue latest"><span>'. $text_new . '</span></div>';
                                                                    }                                                                 
                                                                    echo '<a href="'.$submenu['product']['link'].'"><img src="'.$submenu['product']['image'].'" alt=""></a></div>';
                                                                    ...
                                                                    if($theme_options->get( 'type_sale' ) == '1') {
                                                                        ...
                                                                        echo '<div class="label-discount green sale"><span>-' . round($procent) .'%</span></div>';
                                                                    }
                                                                    }
                                                                    echo '<a href="'.$submenu['product']['link'].'">'.$submenu['product']['name'].'</a></div>';
																	echo '<div class="price">';
																		if (!$submenu['product']['special']) {
																			echo $submenu['product']['price'];
																		} else {
                                                                            echo '<span class="price-old">'. $submenu['product']['price'] .'</span> <span class="price-new">'. $submenu['product']['special'] . '</span>';
																		}
															     ...
															     echo '<div class="products-carousel-overflow clearfix">';
     															     ...
     															     foreach($submenu['products'] as $product) {
                                                                        ...
                                                                        echo '<div class="image">';
                                                                            ...
                                                                            echo '<a href="'.$product['link'].'">'.$product['name'].'</a></div>';
          																	echo '<div class="price">';
