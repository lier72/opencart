  ...
  <div class="panel-body">
    <div class="row">
      ...
      <div class="col-sm-3"><strong><?php echo $store; ?></strong><br />
        ...
        <?php if ($geocode) { ?>
         <a href="//maps.google.com/maps?q=<?php echo urlencode($geocode); ?>&hl=<?php echo $geocode_hl; ?>&t=m&z=15" target="_blank" class="btn btn-info"><i class="fa fa-map-marker"></i> <?php echo $button_map; ?></a>
        <?php } ?>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-3"><strong><?php echo $location['name']; ?></strong><br />
            ...
            <?php if ($location['geocode']) { ?>
             <a href="//maps.google.com/maps?q=<?php echo urlencode($location['geocode']); ?>&hl=<?php echo $geocode_hl; ?>&t=m&z=15" target="_blank" class="btn btn-info"><i class="fa fa-map-marker"></i> <?php echo $button_map; ?></a>
            <?php } ?>
          </div>
          <div class="col-sm-3"> <strong><?php echo $text_telephone; ?></strong><br>
